//google
(function(window, document, 'script', '\/\/www.google-analytics.com/analytics.js', 'ga', a, m) {
    ...
    switch (hostname) {
        ...
        default :
            if (hostname.match(/^(us|ca|uk|au|nz|ja|fr)\.lianjia\.com/g) !== null) {
                ...
                pid = 'lianjiamweb';
            } else if (hostname.match(/^(\S+\.)*(bj|sh|gz|sz|tj|cd|nj|hz|qd|dl|xm|wh|cq|cs|xa|jn|sjz|yt|www|research)\.lianjia\.com/g) !== null) {
                pid = 'lianjiaweb';
            }
            break;
    }
